...
export default function EventHighlights() {
    const aboutAim1 = "The Annual Investment Meeting (AIM Congress) 2025 is dedicated to advancing the future of globalized investment and its industrial impact by charting the course for emerging investment trends. "
    const aboutAim2 = "AIM Congress 2025 aims to create a more balanced global framework, identify opportunities within a dynamic economic environment, and unlock the potential of every business, country, and region. "
    const aboutAim3 = "By fostering economic diversification and providing actionable insights into emerging trends, AIM Congress 2025 will empower investors to make strategic, informed decisions that align with their goals and requirements as well as equip participants to navigate a rapidly evolving landscape, ensuring that their investment choices are both prudent and aligned with long-term objectives."
