            ...
            <div className='startup-registerPage-wrapper portfolio-margin-top'>
                        ...
                        <div className="container inner-banner-component">
                            <div className="row">
                                <div className="col-12">
                                    <h1 className='banner-heading '>Partner Up: Spark <br />
                                        Innovation and Growth!</h1>
                                </div>

                                <div className="col-12">
                                    <h2 className='subBannerHeading'>Be a Catalyst for Future Innovation and Growth</h2>
                                </div>
                            </div>
                        </div>
                ...
                <section>
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                <h2 className='heading-startup section-heading'>Partner Registeration</h2>
                            </div>
                            <div className="col-12">
