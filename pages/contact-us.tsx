                                                ...
                                                <div className="form-group col-12 col-lg-6 col-xl-6">
                                                    <fieldset className="_form-fieldset">
                                                        ...
                                                        <div className="_row _checkbox-radio">
                                                            ...
                                                            />
                                                            <span>
                                                                <label htmlFor="field_61Foreign Direct Investment">Foreign Direct Investment</label>
                                                            </span>
                                                        </div>
                                                        <div className="_row _checkbox-radio">
                                                            <input
                                                                id="field_61Global Trade"
                                                                type="radio"
                                                                name="field[61][]"
                                                                value="Global Trade"
                                                            />
                                                            <span>
                                                                <label htmlFor="field_61Global Trade">Global Trade</label>
                                                            </span>
                                                        </div>
                                                        <div className="_row _checkbox-radio">
                                                            <input
                                                                id="field_61Global Manufacturing"
                                                                type="radio"
                                                                name="field[61][]"
                                                                value="Global Manufacturing"
                                                            />
                                                            <span>
                                                                <label htmlFor="field_61Global Manufacturing">Global Manufacturing</label>
                                                            </span>
                                                        </div>
                                                        <div className="_row _checkbox-radio">
                                                            <input
                                                            ...
                                                            />
                                                            <span>
                                                                <label htmlFor="field_61Future Cities">Future Cities</label>
                                                            </span>
                                                        </div>
                                                        <div className="_row _checkbox-radio">
                                                            <input
                                                            ...
                                                            />
                                                            <span>
                                                                <label htmlFor="field_61Digital Economy">Digital Economy</label>
                                                            </span>
                                                        </div>
                                                        <div className="_row _checkbox-radio">
                                                            <input
                                                            ...
                                                            />
                                                            <span>
                                                                <label htmlFor="field_61Future Finance">Future Finance</label>
                                                            </span>
                                                        </div>
                                                        <div className="_row _checkbox-radio">
                                                            <input
                                                                id="field_61Startups &amp; Unicorns"
                                                                type="radio"
                                                                name="field[61][]"
                                                                value="Startups &amp; Unicorns"
                                                            />
                                                            <span>
                                                                <label htmlFor="field_61Startups &amp; Unicorns">Startups & Unicorns</label>
                                                            </span>
                                                        </div>
                                                        <div className="_row _checkbox-radio">
                                                            <input
                                                            ...
                                                            />
                                                            <span>
                                                                <label htmlFor="field_61Entrepreneurs">Entrepreneurs</label>
                                                            </span>
                                                        </div>
                                                    </fieldset>
                                                </div>
