                                    ...
                                    <div className="m-b-40">
                                        <Link passHref legacyBehavior href={`/partner/${Helper.formatUrlParameter(s.name.value)}`}>
                                            <a rel="noreferrer noopener">
                                                <div className="m-b-20" style={{ margin: "0 auto", marginBottom: "10px", width: "200px", height: "200px", background: "url(" + s.logo.value[0].url + ")", backgroundSize: "contain", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}></div>
                                                {/* <img
                          className="m-b-20"
                            ...
                            section == "super" ? (
                                <div className="col-12 col-md-4 text-center m-b-20">
                                    <div className="m-b-40">
                                        <Link passHref legacyBehavior href={`/partner/${Helper.formatUrlParameter(s.name.value)}`}>
                                            <a rel="noreferrer noopener">
                                                <div className="m-b-20" style={{ margin: "0 auto", width: "160px", height: "160px", background: "url(" + s.logo.value[0].url + ")", backgroundSize: "contain", backgroundPosition: "center", backgroundRepeat: "no-repeat" }}></div>
